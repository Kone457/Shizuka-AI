...
const linkRegex = /(chat\.whatsapp\.com\/[0-9A-Za-z]{20,24})|(https:\/\/whatsapp\.com\/channel\/[0-9A-Za-z]{20,24})/i
...
export async function before(m, { conn, isAdmin, isBotAdmin, isModeration }) {
  ...
  if (chat.antiLink && isGroupLink && !isAdmin && isBotAdmin && !isModeration && m.key.participant !== botId) {
