...
handler.all = async (m, { conn }) => {
  ...
  global.fotoperfil  = await conn
    ...
    .catch(_ => 'https://raw.githubusercontent.com/Kone457/Nexus/refs/heads/main/sss.jpg');
  ...
  const buffer = await fetch(links[rnd]).then(r => r.buffer());
  global.icons  = buffer;
  ...
  // 🏷️ Plantilla para stickers
  global.packsticker  = `°.⎯⃘... Usuario: ${global.nombre}\nBot: ${conn.user.name}\nFecha: ${global.fecha}\nHora: ${global.tiempo}`;
  global.packsticker2 = `\n°.⎯⃘...\n${global.creador}`;
